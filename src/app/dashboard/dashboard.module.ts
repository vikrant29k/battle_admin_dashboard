...
@NgModule({
  ...
  declarations: [DashboardComponent, SliderComponent, ScoreboardComponent, HeaderComponent, NewsUpdateComponent, NewsListComponent, ProfileComponent, DialogAnimationsComponent, ImportExcelComponent, MatchComponent, EditFormDialogComponent, HourlyExcelEditFormDialogComponent, SuperAdminDashboardComponent],
  imports: [
    CommonModule,
